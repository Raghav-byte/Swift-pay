...
import com.swiftpay.analytics.dto.DependencyHealthDTO;
import com.swiftpay.analytics.dto.HealthResponseDTO;
...
public class HealthController {
    ...
    private final ConsumerFactory<String, PaymentCompletedEvent> consumerFactory;
    ...
    @Operation(
            summary = "Overall health check for analytics worker",
            responses = {
